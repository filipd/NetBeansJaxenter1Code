...
// Model for Customer entity
    models.Customer = Backbone.Model.extend({
        urlRoot: "http://localhost:8080/CustomerService/webresources/com.mycompany.customerservice.customer/",
        ...
        sync: function(method, model, options) {
            ...
            if (method == 'create') {
                options.url = 'http://localhost:8080/CustomerService/webresources/com.mycompany.customerservice.customer/';
            }
            if (method == 'update') {
                options.url = 'http://localhost:8080/CustomerService/webresources/com.mycompany.customerservice.customer/';
            }
    ...
    models.CustomerCollection = Backbone.Collection.extend({
        ...
        url: "http://localhost:8080/CustomerService/webresources/com.mycompany.customerservice.customer/",
        sync: function(method, model, options) {
            options || (options = {});
            var errorHandler = {
                error: function(jqXHR, textStatus, errorThrown) {
